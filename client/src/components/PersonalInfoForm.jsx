    ...
    return (
        <div>
            ...
            <div className='flex items-center gap-2'>
                <label>
                    {data.image ? (
                        <img src={typeof data.image === 'string' ? data.image : URL.createObjectURL(data.image)} alt="user-image" className='w-16 h-16 rounded-full object-cover mt-5 ring ring-slate-300 hover:opacity-80' style={{ backgroundColor: typeof data.image === 'string' ? accentColor + '70' : 'transparent' }} />
                    ) : (
                        <div className='inline-flex items-center gap-2 mt-5 text-slate-600 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 cursor-pointer'>
                ...
                {typeof data.image === 'object' && (
                    <div className='flex flex-col gap-1 pl-4 text-sm'>
                        ...
                        <label className='relative inline-flex items-center cursor-pointer text-gray-900 gap-3'>
                            ...
                            <div className='w-9 h-5 bg-slate-300 dark:bg-slate-700 rounded-full peer peer-checked:bg-green-600 transition-colors duration-200'>
                            </div>
